    ...
    return `
        ...
        <div class="setting-row">
            ...
            <div class="segment-button today-emotion-title-segment">
                <button
                    class="segment-option active today-emotion-title-segment-option"
                    data-value="true"
                >
                    ON
                </button>
                <button
                    class="segment-option today-emotion-title-segment-option"
                    data-value="false"
                >
                    OFF
                </button>
        ...
        <div class="setting-row">
            ...
            <div>
                <input
                    class="emoji-size-slider"
                    type="range"
                    min="24"
                    max="120"
                    value="64"
                >
                <span class="emoji-size-value">
                    64px
                </span>
            </div>
        </div>
        ...
        <div class="setting-row">
            ...
            <div>
                <input
                    class="display-mood-count-slider"
                    type="range"
                    min="1"
                    max="5"
                    value="5"
                >
                <span class="display-mood-count-value">
                    5
                </span>
            </div>
        </div>
        ...
        <div class="setting-row">
            ...
            <input
                class="today-emotion-image-input"
                type="file"
